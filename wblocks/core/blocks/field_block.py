...
class TextBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from wblocks.admin.widgets import AdminAutoHeightTextInput
...
class DateBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from wblocks.admin.widgets import AdminDateInput
        field_kwargs = {
...
class TimeBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from wblocks.admin.widgets import AdminTimeInput
...
class DateTimeBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from wblocks.admin.widgets import AdminDateTimeInput
        field_kwargs = {
...
class ChoiceBlock(FieldBlock):
    ...
    def deconstruct(self):
        ...
        """
        return ('wblocks.core.blocks.ChoiceBlock', [], self._constructor_kwargs)
...
DECONSTRUCT_ALIASES = {
    cls: 'wblocks.core.blocks.%s' % cls.__name__
